...
package <- "/Users/sophshan/Desktop/OneDrive - University of North Carolina at Chapel Hill/UNC/Spring 2024/BIOS 735/Class Notes/foo"

#package <- "/Users/sophshan/Desktop/OneDrive - University of North Carolina at Chapel Hill/UNC/Spring 2024/BIOS #735/Homework Assignments/bios735"
...
ANSWER: The vectorized version of the random walk is
0.7 times faster than the C++ version.
...
randomWalkVectorized <- function(niter,lambda) {
  ...
  #Generate the sets of random steps 
  x <- c(0, 2.0 * rbinom(niter-1,1,0.5) - 1.0)
  y <- c(0, 2.0 * rbinom(niter-1,1,0.5) - 1.0)
  
  #Scale by lambda
  x_scaled  <- lambda * x
  y_scaled <- lambda * y
  
  #Sum the steps cumulatively 
  x_c <- cumsum(x_scaled)
  y_c <- cumsum(y_scaled)
...
ANSWER: The C++ version is 800 times faster. 
